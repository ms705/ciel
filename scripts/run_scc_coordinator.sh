...
${PYTHON} ${BASE}/src/python/skywriting/__init__.py --role scc_coordinator --master ${MASTER} --port $WORKER_PORT --staticbase $BASE/src/js/skyweb_worker/ --lighttpd-conf $BASE/src/python/skywriting/runtime/lighttpd.conf -b $BASE/$REL_BLOCK_LOCATION -T ciel-process-aaca0f5eb4d2d98a6ce6dffa99f8254b $*
